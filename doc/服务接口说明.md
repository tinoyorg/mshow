...
- **body数据** : 需要在请求的body中传递的data数据，示例如下
...
POST	/user/object_type/{like_type}/object_id/{like_type_id}/like
...
DELETE	/user/object_type/{like_type}/object_id/{like_type_id}/like
...
POST	/user/object_type/{star_type}/object_id/{star_type_id}/star
...
DELETE	/user/object_type/{star_type}/object_id/{star_type_id}/star
